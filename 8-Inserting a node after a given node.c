// Simply inserting node after a given node from a linked list
...
void insert_node_after(struct node * ptr)
{
    struct node * new_node = (struct node *)malloc(sizeof(struct node));
    int value, number;
    
    printf("\nAfter which value you want to insert the succesive node\n");
    scanf("%d", &value);
    ...
    {
        printf("No element added to the list");
    }
